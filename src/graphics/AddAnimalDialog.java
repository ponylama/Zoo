...
public class AddAnimalDialog extends JDialog implements ItemListener, ActionListener {
    ...
    private String[] herb = {"Elephant","Giraffe","Turtle"};
    private String[] car = {"Lion"};
    private String[] omni = {"Bear"};
    ...
    public AddAnimalDialog(String animalkind, ZooPanel pan, String title)
    {
		...
		if (this.animalkind.equals("class Factory.HerbivoreFactory")){
			this.animals = this.herb;
		}
		if (this.animalkind.equals("class Factory.CarnivoreFactory")){
			this.animals = this.car;
		}
		if (this.animalkind.equals("class Factory.OmnivoreFactory")){
			this.animals = this.omni;
		}
